...
Differenza sostanziale rispetto a export_pages.py: qui nella pagina non finisce
nessun dato. Annunci, prodotti, configurazioni e registro arrivano da
/api/store al momento in cui il browser apre il tabellone. Percio' questo file
